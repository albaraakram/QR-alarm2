...
class MainActivity : AppCompatActivity() {
    ...
    private val permissionLauncher = registerForActivityResult(ActivityResultContracts.RequestMultiplePermissions()) { results ->
        ...
        if (denied.isNotEmpty()) {
            Toast.makeText(this, "íÌÈ ãäÍ ÇáÕáÇÍíÇÊ ÇáãØáæÈÉ áÚãá ÇáÊØÈíÞ", Toast.LENGTH_LONG).show()
        }
    }
    ...
    private val qrEnrollmentLauncher = registerForActivityResult(ScanContract()) { result ->
        ...
        if (contents != null) {
            ...
            Toast.makeText(this, "Êã ÍÝÙ ÑãÒ QR", Toast.LENGTH_SHORT).show()
            ...
            Toast.makeText(this, "áã íÊã ÇáÊÞÇØ ÑãÒ", Toast.LENGTH_SHORT).show()
        }
    }
